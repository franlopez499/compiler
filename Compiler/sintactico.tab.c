...
#line 94 "sintactico.tab.c" /* yacc.c:339  */
...
#line 181 "sintactico.tab.c" /* yacc.c:358  */
...
{
       0,    39,    39,    39,    69,    69,    70,    70,    71,    72,
      73,    77,    78,    82,    85,   103,   104,   108,   124,   125,
     168,   189,   217,   258,   259,   260,   263,   264,   268,   290,
     320,   350,   381,   395,   413,   430,   447,   458,   459,   476
};
#endif
...
{
  "$end", "error", "$undefined", "LPAREN", "RPAREN", "LLLAVE", "RLLAVE",
  "VAR", "CONST", "SEMICOLON", "COMMA", "ASSIGNOP", "ELSE", "IF", "WHILE",
  "FUNC", "PRINT", "READ", "DO", "STRING", "INT", "ID", "MINUSOP",
  "PLUSOP", "MULTOP", "DIVOP", "UMINUS", "$accept", "program", "$@1",
  "declarations", "$@2", "$@3", "identifier_list", "asig",
  "statements_list", "statement", "print_list", "print_item", "read_list",
...
{
     -35,    13,     2,   -35,    27,    18,    55,    47,   -35,    -2,
      49,    50,    48,    63,    53,    73,    53,    87,   -35,   -35,
      84,   103,    78,    86,    72,    97,   -35,   -35,    98,     9,
     -35,   -35,    34,   -35,    62,    81,    81,    81,   -35,   -35,
     -35,    81,    82,   -35,   -14,   -35,    85,    96,    81,    81,
     -35,    53,   -35,   -35,     0,     8,    12,   -35,   -35,    78,
      81,    81,    81,    81,   -35,    90,   109,    33,   -14,   -35,
      72,    72,   -35,   -35,    80,    80,   -35,   -35,   -35,    81,
     -35,   101,   -35,    16,    72,   -35,   -35
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,     0,     0,     0,     0,    15,     8,    13,     0,
      11,     9,     0,    25,     0,     0,     0,     0,    29,    39,
      38,     0,     0,    26,    28,    30,     0,     0,     0,     0,
       5,     0,     7,    18,     0,     0,     0,    36,    23,     0,
       0,     0,     0,     0,    24,     0,     0,     0,    14,    12,
       0,     0,    37,    27,    33,    32,    34,    35,    31,     0,
      17,    20,    22,     0,     0,    21,    19
};
...
{
     -35,   -35,   -35,   -35,   -35,   -35,    99,    65,   100,   -24,
     -35,    58,   -35,   -34
};
...
{
      47,    54,    55,    56,    70,    10,    11,    57,    60,    61,
      62,    63,    71,     3,    67,    68,    72,     4,    50,    51,
      85,     6,    60,    61,    62,    63,    74,    75,    76,    77,
      60,    61,    62,    63,    60,    61,    62,    63,    60,    61,
      62,    63,    80,    52,    51,    83,    81,    82,     5,    17,
      13,    15,     8,    18,    19,    60,    61,    62,    63,     7,
      86,    20,    21,    17,    22,    23,    24,    18,    53,    25,
      -4,    -6,    27,    17,    28,    20,    21,    18,    22,    23,
      24,    37,    31,    25,    37,    20,    21,    35,    22,    23,
      24,    58,    59,    25,    64,    65,    33,    38,    39,    40,
      41,    39,    40,    41,    62,    63,    36,    45,    48,    49,
      66,    78,    79,    84,     0,    32,    69,    73,    34
};

static const yytype_int8 yycheck[] =
{
      24,    35,    36,    37,     4,     7,     8,    41,    22,    23,
      24,    25,     4,     0,    48,    49,     4,    15,     9,    10,
       4,     3,    22,    23,    24,    25,    60,    61,    62,    63,
      22,    23,    24,    25,    22,    23,    24,    25,    22,    23,
      24,    25,     9,     9,    10,    79,    70,    71,    21,     1,
       1,     1,     5,     5,     6,    22,    23,    24,    25,     4,
      84,    13,    14,     1,    16,    17,    18,     5,     6,    21,
      21,    21,     9,     1,    21,    13,    14,     5,    16,    17,
      18,     3,     9,    21,     3,    13,    14,     3,    16,    17,
      18,     9,    10,    21,     9,    10,     9,    19,    20,    21,
      22,    20,    21,    22,    24,    25,     3,    21,    11,    11,
      14,    21,     3,    12,    -1,    16,    51,    59,    18
};
...
{
       0,    28,    29,     0,    15,    21,     3,     4,     5,    30,
       7,     8,    35,     1,    31,     1,    32,     1,     5,     6,
      13,    14,    16,    17,    18,    21,    36,     9,    21,    33,
      34,     9,    33,     9,    35,     3,     3,     3,    19,    20,
      21,    22,    37,    38,    40,    21,    39,    36,    11,    11,
       9,    10,     9,     6,    40,    40,    40,    40,     9,    10,
      22,    23,    24,    25,     9,    10,    14,    40,    40,    34,
       4,     4,     4,    38,    40,    40,    40,    40,    21,     3,
       9,    36,    36,    40,    12,     4,    36
};
...
{
       0,    27,    29,    28,    31,    30,    32,    30,    30,    30,
      30,    33,    33,    34,    34,    35,    35,    36,    36,    36,
...
#line 82 "sintactico.y" /* yacc.c:1646  */
    {(yyval.codigo)= creaLC();
if (!(perteneceTablaS((yyvsp[0].cadena)))) {anadeEntradaVar((yyvsp[0].cadena),tipoId);}
 				else {printf("Error, Variable %s ya declarada \n",(yyvsp[0].cadena));}}
#line 1407 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 85 "sintactico.y" /* yacc.c:1646  */
    {
			...
			if (!(perteneceTablaS((yyvsp[-2].cadena)))) { 
				anadeEntradaVar((yyvsp[-2].cadena),tipoId);
				concatenaLC((yyval.codigo),(yyvsp[0].codigo));
				char * arg1 = concatenaCadenas("_",(yyvsp[-2].cadena));
				Operacion operacion = {"sw",recuperaResLC((yyvsp[0].codigo)),arg1,NULL};
...
#line 103 "sintactico.y" /* yacc.c:1646  */
    {(yyval.codigo)=(yyvsp[-1].codigo); concatenaLC((yyvsp[-1].codigo), (yyvsp[0].codigo)); liberaLC((yyvsp[0].codigo)); }
...
#line 108 "sintactico.y" /* yacc.c:1646  */
    {
		...
		(yyval.codigo)=creaLC();
		if (!(perteneceTablaS((yyvsp[-3].cadena)))) {printf("Error, Variable %s no declarada \n",(yyvsp[-3].cadena));} 
		else if (esConstante((yyvsp[-3].cadena))) {printf("Error, Asignacion a constante %s\n", (yyvsp[-3].cadena));}
			else{
				concatenaLC((yyval.codigo),(yyvsp[-1].codigo));
    			char * arg1 = concatenaCadenas("_",(yyvsp[-3].cadena));
				Operacion operacion = {"sw",recuperaResLC((yyvsp[-1].codigo)),arg1,NULL};
    			insertaLC((yyval.codigo), finalLC((yyval.codigo)), operacion);
    			marcarRegistroLibre(operacion.res);
...
#line 125 "sintactico.y" /* yacc.c:1646  */
    {
		(yyval.codigo)=(yyvsp[-4].codigo);
			...
			Operacion operacion = {"beqz",recuperaResLC((yyvsp[-4].codigo)),generarEtiqueta(),NULL};
    		insertaLC((yyval.codigo), finalLC((yyval.codigo)), operacion);
			marcarRegistroLibre(operacion.res);
...
#line 168 "sintactico.y" /* yacc.c:1646  */
    {
		...
		Operacion operacion = {"beqz",recuperaResLC((yyvsp[-2].codigo)),generarEtiqueta(),NULL};
    		insertaLC((yyval.codigo), finalLC((yyval.codigo)), operacion);
		marcarRegistroLibre(operacion.res);
		concatenaLC((yyval.codigo), (yyvsp[0].codigo));
...
#line 1569 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 217 "sintactico.y" /* yacc.c:1646  */
    ...
    operacion.op = "beqz";
    operacion.res= recuperaResLC((yyvsp[-2].codigo));
...
#line 268 "sintactico.y" /* yacc.c:1646  */
    {
		(yyval.codigo)=(yyvsp[0].codigo);
    		Operacion operacion = {"move","$a0",recuperaResLC((yyvsp[0].codigo)),NULL};
    		insertaLC((yyval.codigo), finalLC((yyval.codigo)), operacion);
...
#line 1671 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 290 "sintactico.y" /* yacc.c:1646  */
    {	
			(yyval.codigo)=creaLC();
			anadeEntradaCadena((yyvsp[0].cadena));
			contCadenas++;		
...
#line 320 "sintactico.y" /* yacc.c:1646  */
    {
		if (!(perteneceTablaS((yyvsp[0].cadena)))){(yyval.codigo)=creaLC();printf("Error, Variable %s no declarada \n",(yyvsp[0].cadena));} 
		else{
                     if (esConstante((yyvsp[0].cadena))) {(yyval.codigo)=creaLC();printf("Error, Asignacion a constante %s\n", (yyvsp[0].cadena));}
		     else{
			...
			(yyval.codigo)=creaLC();
    			...
    			operacion.op="sw";
    			operacion.res= "$v0";
			char* arg1 = concatenaCadenas("_",(yyvsp[0].cadena));
    			operacion.arg1= arg1;
    			operacion.arg2= NULL;
   			insertaLC((yyval.codigo), finalLC((yyval.codigo)), operacion);
    			guardaResLC((yyval.codigo), operacion.res);
...
#line 350 "sintactico.y" /* yacc.c:1646  */
    {if (!(perteneceTablaS((yyvsp[0].cadena)))){printf("Error, Variable %s no declarada \n",(yyvsp[0].cadena));}
		else{
                     if (esConstante((yyvsp[0].cadena))) {printf("Error, Asignacion a constante %s\n", (yyvsp[0].cadena));}
		     else{
...
#line 1772 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 381 "sintactico.y" /* yacc.c:1646  */
    {
    	...
    	concatenaLC((yyval.codigo), (yyvsp[-2].codigo));
    	concatenaLC((yyval.codigo), (yyvsp[0].codigo));
    	Operacion operacion = {"add",nuevoRegistro(),recuperaResLC((yyvsp[-2].codigo)),recuperaResLC((yyvsp[0].codigo))};
...
#line 395 "sintactico.y" /* yacc.c:1646  */
	...
	(yyval.codigo)=creaLC();
    	concatenaLC((yyval.codigo), (yyvsp[-2].codigo));
    	concatenaLC((yyval.codigo), (yyvsp[0].codigo));
    	Operacion operacion = {"sub",nuevoRegistro(),recuperaResLC((yyvsp[-2].codigo)),recuperaResLC((yyvsp[0].codigo))};
...
#line 1814 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 413 "sintactico.y" /* yacc.c:1646  */
	...
	(yyval.codigo)=creaLC();
    	concatenaLC((yyval.codigo), (yyvsp[-2].codigo));
	concatenaLC((yyval.codigo), (yyvsp[0].codigo));
    	Operacion operacion = {"mul",nuevoRegistro(),recuperaResLC((yyvsp[-2].codigo)),recuperaResLC((yyvsp[0].codigo))};
...
#line 430 "sintactico.y" /* yacc.c:1646  */
    {
    	...
    	concatenaLC((yyval.codigo), (yyvsp[-2].codigo));
		concatenaLC((yyval.codigo), (yyvsp[0].codigo));
    	Operacion operacion = {"div",nuevoRegistro(),recuperaResLC((yyvsp[-2].codigo)),recuperaResLC((yyvsp[0].codigo))};
...
#line 447 "sintactico.y" /* yacc.c:1646  */
    {
		...
		(yyval.codigo)=creaLC();
    	concatenaLC((yyval.codigo), (yyvsp[0].codigo));
    	Operacion operacion = {"neg",nuevoRegistro(),recuperaResLC((yyvsp[0].codigo)),NULL};
...
#line 1874 "sintactico.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 458 "sintactico.y" /* yacc.c:1646  */
    {(yyval.codigo)= (yyvsp[-1].codigo);}
#line 1880 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 1902 "sintactico.tab.c" /* yacc.c:1646  */
    break;
...
#line 476 "sintactico.y" /* yacc.c:1646  */
    {
		...
		(yyval.codigo)=creaLC();
    	Operacion operacion = {"li",nuevoRegistro(),(yyvsp[0].cadena),NULL};
...
#line 489 "sintactico.y" /* yacc.c:1906  */
